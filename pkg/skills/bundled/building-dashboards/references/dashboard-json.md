# Dashboard and panel JSON schema

<!-- Adapted from grafana/skills (Apache-2.0): https://github.com/grafana/skills/tree/0519662/skills/grafana-core/dashboarding/references/json-schema.md -->
...
Loki annotation (e.g. overlay deploys on every timeseries panel):

...
<!-- Adapted from grafana/skills (Apache-2.0): https://github.com/grafana/skills/tree/0519662/skills/grafana-lgtm/tempo/references/traceql.md -->
...
resource.service.name        # resource-level (from the SDK)
...
# Structural: server span with a downstream error
{ kind = server } >> { status = error }

# Both conditions present anywhere in the trace

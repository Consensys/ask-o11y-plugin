...
export const AppLoader: React.FC<AppLoaderProps> = ({ text = 'Loading Ask O11y...' }) => {
  ...
  return (
    <div data-testid="app-loader" className="flex flex-col items-center justify-center min-h-[300px] animate-fadeIn">
...
export const InlineAppLoader: React.FC<AppLoaderProps> = ({ text = 'Loading Ask O11y...' }) => {
  return (
    <div data-testid="inline-app-loader" className="flex items-center gap-2 py-4">
      <Spinner size="md" />
